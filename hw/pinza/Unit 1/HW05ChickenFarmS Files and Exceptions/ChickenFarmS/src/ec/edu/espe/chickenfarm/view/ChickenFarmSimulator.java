...
public class ChickenFarmSimulator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("HW05 Files and Exceptions");
        System.out.println("====================");
...
*/
        ...
        ArrayList<Chicken> list = chickenList(read);
        File f = new File("./chicken.csv");
        //Application and use of try catch exceptions:
        try (FileWriter fw = new FileWriter(f);) {
            for (Chicken chicken3 : list) {
                fw.write(chicken3.toCsv() + "\n");
            }
        } catch (Exception e) {
            System.out.println("A unexpected error happened!");
        }
...
*/
    ...
    //DESDE AQUÍ EL DEBER 5
    //READ AND WRITE CSV FILES.
    public static ArrayList<Chicken> chickenList(Scanner read) {
        ...
        do {
            ...
            if (!confirmation.equalsIgnoreCase("NO")) {
                ...
                c = new Chicken(confirmation, id, name, age, color, isMolting);
                list.add(c);
