 ...
 */
public class FrmUpdateTutorship extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update tutorship");
        ...
        txtId.setBackground(new java.awt.Color(51, 204, 255));
...
private void btmBatch() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmUpdateTutorship.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmUpdateTutorship().setVisible(true);
            }
        });
    }
