 ...
 */
public class FrmReadtutorship extends javax.swing.JFrame {
DefaultTableModel model = new DefaultTableModel();
Controller controller = new Controller();
    /**
     * Creates new form Frm
     */
    public FrmReadtutorship() {
        initComponents();
        mostTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Read tutorship");
  ...
  private void mostTable() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Tutorship resident = new Tutorship(txtId.getText(), "", "");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReadtutorship.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmReadtutorship().setVisible(true);
            }
        });
    }
