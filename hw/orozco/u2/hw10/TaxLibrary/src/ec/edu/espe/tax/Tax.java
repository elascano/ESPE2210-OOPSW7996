...
public class Tax {
    ...
    public static float computeGreenTax(float cylinderCapacity, int carYear, String carType){
        ...
        else if(cylinderCapacity>1500 && cylinderCapacity<=2000){amountPerCylinder=0.08F;}
        else if(cylinderCapacity>2000 && cylinderCapacity<=2500){amountPerCylinder=0.09F;}
        else if(cylinderCapacity>2500 && cylinderCapacity<=3000){amountPerCylinder=0.11F;}
        else if(cylinderCapacity>3000 && cylinderCapacity<=3500){amountPerCylinder=0.12F;}
        else if(cylinderCapacity>3500 && cylinderCapacity<=4000){amountPerCylinder=0.24F;}
        else if(cylinderCapacity>4000)                          {amountPerCylinder=0.35F;}
