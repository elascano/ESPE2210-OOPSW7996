...
import ec.edu.espe.singletoninfrm.model.Beverage;
...
public class FrmCandy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblCandy);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        MessageFormat header = new MessageFormat("Inventario de Dulces");
        MessageFormat footer = new MessageFormat("page {0}");

        try {
            tblCandy.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        } catch (Exception e) {
            e.getMessage();
        }
