...
import ec.edu.espe.ws21_crud.exception.TwoOptionsException;
...
public class Ws21_CRUD {
    ...
    public static void main(String[] args) throws TwoOptionsException {
    ...
    private static void crateFile(Scanner scan, ArrayList<TVSet> continents) throws TwoOptionsException {
        String fileName;
        int enter = 0;
        ...
        do {
            try{
                ...
                enter = scan.nextInt();
                if (enter > 2 || enter < 1){
                    throw new TwoOptionsException(enter);
                }
            }catch(TwoOptionsException ex){
