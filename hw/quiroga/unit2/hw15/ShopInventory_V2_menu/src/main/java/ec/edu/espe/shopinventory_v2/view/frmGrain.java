        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Grain deleted succesfully", "Delete Product", JOptionPane.INFORMATION_MESSAGE);
                    txtID.setText("");
                    txtName.setText("");
                    txtQuantity.setText("");
                    txtPrice.setText("");
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Grain updated succesfully", "Update Product", JOptionPane.INFORMATION_MESSAGE);    
