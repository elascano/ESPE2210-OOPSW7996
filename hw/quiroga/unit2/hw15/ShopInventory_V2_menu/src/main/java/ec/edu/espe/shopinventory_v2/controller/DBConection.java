...
public class DBConection {
    ...
    public static boolean addProduct(int productID, String productName, int productQuantity, float productPrice, MongoCollection<Document> productCollection) throws HeadlessException, NumberFormatException {
        boolean flag = false;
    ...
    public static boolean updateProduct(int productID, String productName, int productQuantity, float productPrice, MongoCollection<Document> productCollection) throws NumberFormatException, HeadlessException {
        boolean flag = false;
        Bson filter = Filters.eq("id", productID);
        Document query = productCollection.find(Filters.and(filter)).first();
