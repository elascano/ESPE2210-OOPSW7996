            ...
            try {
                ...
                if(query != null){
                   ...
                   Document beverageDoc = new Document("_id", new ObjectId())
                    ...
                    JOptionPane.showMessageDialog(this, "Meat added succesfully", "Add Product", JOptionPane.INFORMATION_MESSAGE);
                }
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Meat deleted succesfully", "Delete Product", JOptionPane.INFORMATION_MESSAGE);
                    txtID.setText("");
                    txtName.setText("");
                    txtQuantity.setText("");
                    txtPrice.setText("");
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Meat updated succesfully", "Update Product", JOptionPane.INFORMATION_MESSAGE);    
