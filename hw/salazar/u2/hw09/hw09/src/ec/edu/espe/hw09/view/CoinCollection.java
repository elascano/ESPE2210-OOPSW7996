...
import ec.edu.espe.hw09.model.Coin;
import ec.edu.espe.hw09.utils.NegativeValuesException;
import java.io.File;
...
public class CoinCollection {
    ...
    public static void validateTheValue(float value) throws NegativeValuesException {
        if (value <= 0) {
            throw new NegativeValuesException("Please enter a positive number");
        }
    }
