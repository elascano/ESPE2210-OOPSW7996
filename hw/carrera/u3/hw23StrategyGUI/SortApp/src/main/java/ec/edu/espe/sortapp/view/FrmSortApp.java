...
public class FrmSortApp extends javax.swing.JFrame {
    ...
    private void concatenateNumber(String number){
        String newNumber;
        newNumber = lblCurrentNumber.getText() + number;
        lblCurrentNumber.setText(newNumber);
    }
    
    private void addNumberToList(){
        int numberToAdd;
        numberToAdd = Integer.parseInt(lblCurrentNumber.getText());
    ...
    private void changeTypeLabel(){
        arrayLength -= 1;
        
        if(arrayLength >0 && arrayLength<30){
            lblSortType.setText("Bubble Sort: " + arrayLength + " elements");
        }
        
        if(arrayLength >= 30 && arrayLength<100){
            lblSortType.setText("Insertion Sort: "+ arrayLength + " elements");
        }
        
        if (arrayLength >=100){
            lblSortType.setText("Quick Sort: "+ arrayLength+ " elements");
        }
    }
