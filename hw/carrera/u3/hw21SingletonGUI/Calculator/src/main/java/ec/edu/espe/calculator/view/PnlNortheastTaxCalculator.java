 ...
 */
public class PnlNortheastTaxCalculator extends javax.swing.JPanel {

    /**
     * Creates new form PnlNortheastTaxCalculator
     */
    public PnlNortheastTaxCalculator() {
        initComponents();
        spnrTax.setValue(6.35F);
    ...
    private void changeTaxByState(){
        ...
        switch(state){
            case("Connecticut")->{spnrTax.setValue(6.35F);}
            case("Maine")->{spnrTax.setValue(5.5F);}
            case("Massachusetts")->{spnrTax.setValue(6.25F);}
            case("New Hampshire")->{spnrTax.setValue(0.00F);}
            case("New Jersey")->{spnrTax.setValue(6.625F);}
            case("New York")->{spnrTax.setValue(8.875F);}
            case("Pennsylvania")->{spnrTax.setValue(6.00F);}
            case("Rhode Island")->{spnrTax.setValue(7.00F);}
            case("Vermont")->{spnrTax.setValue(6.00F);}
        }
    }
    ...
    private void initComponents() {
        ...
        cbxState.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Connecticut", "Maine", "Massachusetts", "New Hampshire", "New Jersey", "New York", "Pennsylvania", "Rhode Island", "Vermont" }));
