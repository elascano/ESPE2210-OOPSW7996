 ...
 */
public class PnlWestTaxCalculator extends javax.swing.JPanel {

    /**
     * Creates new form PnlWestTaxCalculator
     */
    public PnlWestTaxCalculator() {
        initComponents();
        spnrTax.setValue(0.00F);
    }
    ...
    private void changeTaxByState(){
        ...
        switch(state){
            case("Alaska")->{spnrTax.setValue(0.00F);}
            case("Arizona")->{spnrTax.setValue(5.6F);}
            case("California")->{spnrTax.setValue(7.25F);}
            case("Colorado")->{spnrTax.setValue(2.9F);}
            case("Hawaii")->{spnrTax.setValue(4.00F);}
            case("Idaho")->{spnrTax.setValue(6.00F);}
            case("Montana")->{spnrTax.setValue(0.00F);}
            case("Nevada")->{spnrTax.setValue(6.85F);}
            case("New Mexico")->{spnrTax.setValue(5.125F);}
            case("Oregon")->{spnrTax.setValue(0.00F);}
            case("Utah")->{spnrTax.setValue(4.85F);}
            case("Washington")->{spnrTax.setValue(6.50F);}
            case("Wyoming")->{spnrTax.setValue(4.00F);}
        }
    }
    ...
    private void initComponents() {
        ...
        cbxState.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Alaska", "Arizona", "California", "Colorado", "Hawaii", "Idaho", "Montana", "Nevada", "New Mexico", "Oregon", "Utah", "Washington", "Wyoming" }));
