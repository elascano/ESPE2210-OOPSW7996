...
public class FileManager {
    ...
    public static void enterStore(Scanner scan, ArrayList<Store> store)throws nameException{
    ...
    public static void enterStoreDataTwo(Scanner scan, ArrayList<Store> store) {
        String localName;
        Store storeInfo = new Store();
        System.out.println("====================================");
    ...
    public static void enterStoreDataThree(Scanner scan, ArrayList<Store> store) {
        int id;
        String numberOfId;
        Store storeInfo = new Store();
        System.out.println("====================================");
    ...
    public static void createJsonFile(Scanner scan, ArrayList<Store> store) throws nameException, localNameException, idException {
        String fileName;
        int enter = 0;
        System.out.println(">>Ingress the name of the file you want to create: ");
        fileName = scan.next();
        do {
            enterStore(scan, store);
            enterStoreTwo(scan, store);
            enterStoreThree(scan, store);
