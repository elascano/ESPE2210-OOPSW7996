package espe.edu.ec.desingwithcrud.control;
...
import espe.edu.ec.desingwithcrud.model.Average;
...
public class ConnectionMongo {
    ...
    private static Average updateLocalAverage(Student student) {
        ...
        average.setStudentName(student.getName());
    ...
    private static Document calculateAverageStudent(Document studentDoc) {
        ...
        Average average = new Average();
        String grades;
        average.setStudentName(studentDoc.getString("name"));
        ...
        return new Document("_id", new ObjectId())
                ...
                .append("name", average.getStudentName())
