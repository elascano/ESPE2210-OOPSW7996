package ec.edu.espe.hw12.controller;
...
import ec.edu.espe.hw12.model.Product;
import ec.edu.espe.hw12.model.Sale;
...
public class MongoDB {
    ...
    public static void headerOfThePresentation(int position) {
    ...
    public static void registerProduct() {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                Document product = registerProduct(enteredProduct);

                productCollection.insertOne(product);
                System.out.println("New product has agragated: " + enteredProduct.getName());
    ...
    private static Document registerProduct(Product enteredProduct) throws NumberFormatException {
        String name;
        double unitPrice;
