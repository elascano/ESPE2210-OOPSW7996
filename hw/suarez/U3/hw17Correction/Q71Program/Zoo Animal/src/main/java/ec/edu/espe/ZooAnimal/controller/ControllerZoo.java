package ec.edu.espe.ZooAnimal.controller;
...
public class ControllerZoo {
    ...
    public static void insertAnimal(Animal animal) {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                MongoCollection<Document> collectionResident = database.getCollection("Animals");
    ...
    public static Animal findAnimal(Animal animals) {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            MongoDatabase database = mongoClient.getDatabase("Poo");
            try {
                MongoCollection<Document> collectionBurguer = database.getCollection("Animals");
    ...
    public static void updateAnimal(Animal animals) {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                MongoCollection collectionBurger = database.getCollection("Animals");
    ...
    public static void deleteAnimal(Animal animals) {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            MongoDatabase database = mongoClient.getDatabase("Poo");
            try {
                MongoCollection collectionResident = database.getCollection("Animals");
