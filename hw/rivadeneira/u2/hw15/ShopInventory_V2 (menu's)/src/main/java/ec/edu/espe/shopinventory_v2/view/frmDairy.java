...
public class frmDairy extends javax.swing.JFrame {
            ...
            try {
                ...
                if(query != null){
                   ...
                   Document beverageDoc = new Document("_id", new ObjectId())
                    ...
                    JOptionPane.showMessageDialog(this, "Dairy added succesfully", "Add Product", JOptionPane.INFORMATION_MESSAGE);
                }
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Dairy deleted succesfully", "Delete Product", JOptionPane.INFORMATION_MESSAGE);
                    txtID.setText("");
                    txtName.setText("");
                    txtQuantity.setText("");
                    txtPrice.setText("");
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Dairy updated succesfully", "Update Product", JOptionPane.INFORMATION_MESSAGE);    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDairy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
