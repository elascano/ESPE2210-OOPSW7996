                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(btnStock, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE)))))))
                .addGap(27, 27, 27))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(233, 233, 233)
            ...
            try {
                ...
                if(query != null){
                   ...
                   Document beverageDoc = new Document("_id", new ObjectId())
                    ...
                    JOptionPane.showMessageDialog(this, "Snack added succesfully", "Add Product", JOptionPane.INFORMATION_MESSAGE);
                }
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Snack deleted succesfully", "Delete Product", JOptionPane.INFORMATION_MESSAGE);
                    txtID.setText("");
                    txtName.setText("");
                    txtQuantity.setText("");
                    txtPrice.setText("");
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                if(query != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Snack updated succesfully", "Update Product", JOptionPane.INFORMATION_MESSAGE);    
    ...
    private void btnStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStockActionPerformed
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                Bson filter = Filters.eq("quantity", Integer.parseInt(txtID.getText()));
             //   Document query = productCollection.find(Filters.and(filter)).first().;
                
                MongoCursor<Document> query = productCollection.find().iterator();
                int total = tabla.getRowCount();
                for(int i=0; i<total; i++){
                    tabla.removeRow(0);
                }
