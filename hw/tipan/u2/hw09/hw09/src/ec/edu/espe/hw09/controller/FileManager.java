...
public class FileManager {
    public static ArrayList<Chair> read(ArrayList<Chair> chairs,String fileName){
        ...
        try{
            ...
            System.out.println("The File doesn´t exist in the database");
    ...
    public static int show(ArrayList<Chair> chairs,int id) throws MyException{
       ...
       throw new MyException("The id:[" +id+ "] isn't in the database");
    }
    ...
    public static void update(ArrayList<Chair> chairs){
        ...
        try{
            ...
            if(chairsLocated !=-1){
                ...
                if (material.equals(material1)&& color.equals(color1)){
                    System.out.println("WELCOM TO THE SYSTEM");
                }while(color.equals(color1)==false){
