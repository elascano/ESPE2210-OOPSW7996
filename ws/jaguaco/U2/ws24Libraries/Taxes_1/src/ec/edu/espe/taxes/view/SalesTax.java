...
public class SalesTax {
    public static void main (String[] args){
        ...
        switch (choice) {
            ...
            product = new Product ( id, description, value,  value + Tax.computeIva(value));
            ...
            case 2:
                ...
                if(vehicl == 1){
                    ...
                    printAge();
                    age = sc.nextFloat();
                    greentaxcalculated(cylinder,cylindersection,age);   
                    
                    vehicle = new Vehicle(cylindersection, cylinder, age, greentaxcalculated(cylinder, cylindersection, age) + Tax.computerGreenTax(greentaxcalculated(cylinder, cylindersection, age)));
