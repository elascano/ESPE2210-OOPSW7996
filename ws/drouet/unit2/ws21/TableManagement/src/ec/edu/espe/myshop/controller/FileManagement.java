...
public class FileManagement {
    ...
    public void saveStands(ArrayList<Table> stands, String fileName) {
        Gson gson = new Gson();
    ...
    public ArrayList<Table> loadStands(String fileName) {
        Gson gson = new Gson();
        Collection<Table> newStands = new ArrayList<>();
        ...
        try ( Scanner scFile = new Scanner(new File(pathName));) {
            ...
            newStands = gson.fromJson(jsonFile, new TypeToken<List<Table>>() {
            }.getType());
