package ec.edu.espe.cable.controller;
...
public class FileManagement {
    ...
    public void saveStands(ArrayList<Cable> stands, String fileName) {
        Gson gson = new Gson();
    ...
    public ArrayList<Cable> loadStands(String fileName) {
        Gson gson = new Gson();
        Collection<Cable> newStands = new ArrayList<>();
        ...
        try ( Scanner scFile = new Scanner(new File(pathName));) {
            ...
            newStands = gson.fromJson(jsonFile, new TypeToken<List<Cable>>() {
            }.getType());
