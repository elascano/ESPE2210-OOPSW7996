...
public class MongoCRUD {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)){
            ...
            try
            {
                ...
                Bson modifyProduct = Updates.combine(
                        ...
                        Updates.set("pricePerUnit", product.getPricePerUnit()));
    ...
    public static void updateMongoVAT(int id, String collection, ProductWithVAT product) {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)){
            ...
            try
            {
                ...
                Bson modifyProduct = Updates.combine(
                        ...
                        Updates.set("quantity", product.getQuantity()),
                        Updates.set("pricePerUnit", product.getPricePerUnit()),
                        Updates.set("priceWithVAT", product.getPriceWithVAT()));
