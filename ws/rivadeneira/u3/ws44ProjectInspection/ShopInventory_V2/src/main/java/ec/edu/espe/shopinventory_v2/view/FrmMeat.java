 ...
 */
public class FrmMeat extends javax.swing.JFrame {

    private static final String uri = "mongodb+srv://t07:seb@cluster0.cjkwcyi.mongodb.net/test";
    private static final String collection = "Meat";
    Gson gson = new Gson();
    ...
    public FrmMeat() {
        ...
        tblMeat.setModel(table);
        tblMeat.removeColumn(tblMeat.getColumnModel().getColumn(0));
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblMeat);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            tblMeat.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        } catch (Exception e) {
            e.getMessage();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMeat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
