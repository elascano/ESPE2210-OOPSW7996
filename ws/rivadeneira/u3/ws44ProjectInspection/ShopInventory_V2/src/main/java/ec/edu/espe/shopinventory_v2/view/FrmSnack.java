...
public class FrmSnack extends javax.swing.JFrame {
    ...
    private static final String collection = "Snack";
    Gson gson = new Gson();
    ...
    public FrmSnack() {
        ...
        tblSnack.setModel(table);
        tblSnack.removeColumn(tblSnack.getColumnModel().getColumn(0));
    }
    ...
    private void initComponents() {
        ...
        tblSnack = new javax.swing.JTable();
        ...
        tblSnack.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblSnack);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            tblSnack.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        } catch (Exception e) {
            e.getMessage();
        }
    ...
    private javax.swing.JTable tblSnack;
