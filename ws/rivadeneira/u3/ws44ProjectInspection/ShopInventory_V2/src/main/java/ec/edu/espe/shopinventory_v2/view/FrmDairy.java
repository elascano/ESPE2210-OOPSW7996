...
public class FrmDairy extends javax.swing.JFrame {
    ...
    public FrmDairy() {
        ...
        tblDairy.setModel(table);
        tblDairy.removeColumn(tblDairy.getColumnModel().getColumn(0));
    }
    ...
    private void initComponents() {
        ...
        tblDairy = new javax.swing.JTable();
        ...
        tblDairy.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblDairy);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        MessageFormat header = new MessageFormat("Inventario de Lacteos");
        MessageFormat footer = new MessageFormat("page {0}");

        try {
            tblDairy.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        } catch (Exception e) {
            e.getMessage();
        }
    ...
    private javax.swing.JTable tblDairy;
