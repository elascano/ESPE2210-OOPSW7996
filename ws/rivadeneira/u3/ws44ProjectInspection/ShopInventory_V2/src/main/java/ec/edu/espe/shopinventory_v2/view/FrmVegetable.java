...
public class FrmVegetable extends javax.swing.JFrame {
    ...
    public FrmVegetable() {
        ...
        tblVegetable.setModel(table);
        tblVegetable.removeColumn(tblVegetable.getColumnModel().getColumn(0));
    }
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportActionPerformed
        ...
        try {
            obj = new Util();
            obj.exportToExcel(tblVegetable);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            tblVegetable.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        } catch (Exception e) {
            e.getMessage();
        }
