...
public class CameraRegister {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("*\t\t4.Update a Camera               *");
            System.out.println("*\t\t5.Print Camera                  *");
            ...
            switch (option) {
                ...
                case 2 -> findOneCamera(actualCamerasData);
                
                case 3 -> deleteOneCamera(actualCamerasData);
                
                case 4 -> update(actualCamerasData);
                
                case 5 -> printList(actualCamerasData);
                
                case 6 -> deleteAllCameras(fileName);
                
                case 7 -> System.out.println("*** YOU HAVE EXITED SUCCESSFULLY ***");
