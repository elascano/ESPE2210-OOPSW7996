...
public class RegistrationUrbanization extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Matias Suarez Sistemas");

        mnuUrbanizationTreasury.setText("Urbanization Treasury");
        ...
        mnuResident.setText("Login");
        mnuResident.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N

        itmRegisterResident.setText("Manager");
        ...
        jMenuItem4.setText("Extraordinary");
        ...
        jMenuItem3.setText("Aliquot");
        jMenu5.add(jMenuItem3);

        jMenuItem5.setText("Acces Control");
        jMenu5.add(jMenuItem5);

        jMenuItem6.setText("Acces Card");
