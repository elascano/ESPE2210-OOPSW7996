 ...
 */
public class HardDrivesSystem extends javax.swing.JFrame {

    /**
     * Creates new form UrbanizationTreasury
     */
    
    public HardDrivesSystem() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HardDrivesSystem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HardDrivesSystem().setVisible(true);
            }
        });
    }
