package ec.edu.espe.hardDrivesSystem.controller;
...
public class Manager {
    ...
    public static void insertProduct(HardDrives product) {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                Document docProduct = new Document("_id", new ObjectId())
                        ...
                        .append("interfac", product.getInterfac())
                        .append("storage", product.getStorage());
    ...
    public static HardDrives findProduct(HardDrives product) {
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                try {
                    ...
                    Data = doc.toJson();
                    TypeToken<HardDrives> type = new TypeToken<HardDrives>() {
                    };
    ...
    public static void updateProduct(HardDrives product) {
        String uri = "mongodb+srv://oop09:oop@cluster0.pankc7e.mongodb.net/?retryWrites=true&w=majority";
        ...
        try ( MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            try {
                ...
                Bson updates = Updates.combine(Updates.set("id", product.getId()),
                        Updates.set("interfac", product.getInterfac()),
                        Updates.set("storage", product.getStorage()));
    ...
    public static void deleteProduct(HardDrives product) {
