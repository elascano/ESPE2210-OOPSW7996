...
import ec.edu.espe.ehamanagement.view.FrmPrintCompletedOrderReport;
 ...
 */
public class FrmPrintCompletedOrderReportController {
    public static void insertReport(FrmPrintCompletedOrderReport reportFrame){
    ...
    public static void printReport(FrmPrintCompletedOrderReport reportFrame){
        PrinterJob job = PrinterJob.getPrinterJob();

        job.setPrintable(reportFrame.getPnlPrintCompletedOrderReport1());
