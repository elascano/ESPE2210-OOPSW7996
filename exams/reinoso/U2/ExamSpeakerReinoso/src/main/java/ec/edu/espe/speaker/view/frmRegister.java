            ...
            try {
                ...
                if (query != null) {
                    ...
                    Document cowDoc = new Document("_id", new ObjectId())
                            ...
                            .append("year", Integer.parseInt(txtAge.getText()))
                            .append("brand", txtName.getText());
                            

                    productCollection.insertOne(cowDoc);

                    JOptionPane.showMessageDialog(this, "Speaker added succesfully", "Add Speaker", JOptionPane.INFORMATION_MESSAGE);
                }
