...
import ec.edu.espe.sortApp.controller.NumbersController;
...
public class FrmSort extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSort.setFont(new java.awt.Font("Segoe UI Semibold", 1, 18)); // NOI18N
        ...
        getContentPane().add(btnSort, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 190, 140, 40));
        getContentPane().add(txtNumberD, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 210, -1));

        jLabel2.setFont(new java.awt.Font("Yu Gothic", 1, 16)); // NOI18N
        jLabel2.setText("Numbers in desorder");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 190, 20));

        jLabel3.setFont(new java.awt.Font("Yu Gothic", 1, 16)); // NOI18N
        jLabel3.setText("Numbers in order");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 190, -1));

        txtNumberO.setEnabled(false);
        getContentPane().add(txtNumberO, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 210, -1));
        ...
        getContentPane().add(txtAlgorithm, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 120, 160, -1));
