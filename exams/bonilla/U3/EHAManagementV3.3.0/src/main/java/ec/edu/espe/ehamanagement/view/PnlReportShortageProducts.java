...
public class PnlReportShortageProducts extends javax.swing.JPanel implements Printable{
    ...
    public PnlReportShortageProducts() {
        ...
        this.tblTableShortageProductReport.setModel(tableModel);
        tblTableShortageProductReport.setEnabled(false);
        refreshTable();
    }
    private void refreshTable() {
        ...
        ArrayList <Product> shortageProducts = InventoryReportGenerator.filterProducts(readedProducts, "shortage");
    ...
    private void cleanTable() {
        int row = tblTableShortageProductReport.getRowCount();
