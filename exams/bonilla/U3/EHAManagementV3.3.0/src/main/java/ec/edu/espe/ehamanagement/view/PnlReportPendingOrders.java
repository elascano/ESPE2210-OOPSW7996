 ...
 */
public class PnlReportPendingOrders extends javax.swing.JPanel implements Printable{
    ...
    public PnlReportPendingOrders() {
        ...
        this.tblTablePendingOrdersReport.setModel(model);
        tblTablePendingOrdersReport.setEnabled(false);
        refreshTable();
    }
    ...
    private void refreshTable() {
        ...
        ArrayList <Order> completedOrders = AgendaReportGenerator.filterOrders(readedOrders, "pending");
    ...
    private void cleanTable() {
        int row = tblTablePendingOrdersReport.getRowCount();
