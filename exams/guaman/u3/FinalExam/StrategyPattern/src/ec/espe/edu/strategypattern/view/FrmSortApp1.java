...
import ec.espe.edu.strategypattern.DbManager;
...
public class FrmSortApp1 extends javax.swing.JFrame {
    ...
    private void btnSaveAndExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveAndExitActionPerformed
        ...
        MongoDatabase database = mongoClient.getDatabase("strategyGuaman");
        MongoCollection collection = database.getCollection("arrayAlexander");
    ...
    public static void connectMongoDB() {
        ...
        String dataBaseName = "strategyGuaman";
